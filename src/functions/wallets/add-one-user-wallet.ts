...
export async function addOneUserWallets(
): Promise<SuccessResponse<UserWallet>> {
    try {
        const response = await axiosInstance.post(`/user-wallets`);
        return response.data as SuccessResponse<UserWallet>;
